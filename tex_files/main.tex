...
Section \ref{subsec:bg1} provides a brief introduction into the basic structure and ideas of GNNs (and GCNs). Afterwards, in section
...
performance. As a training procedure for higher robustness, they introduce an optimization-based adversarial training that is not
