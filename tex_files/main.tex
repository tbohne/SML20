...
have certain common properties that are presumably not shared by adversarially perturbed graphs.
...
Based on these properties, they develop an algorithm that is able to generate perturbations that are not only harmful against specific examples,
