...
define them as \textquote{\textit{small deliberate perturbations of data samples in order to achieve the outcome desired by the attacker}}
...
On a less concrete level, it would also be interesting to find out which aspects of perturbations are relevant for their harmfulness
...
by their structural properties. The authors study statistically significant structural properties in perturbations against GNN models.
Based on these properties, they develop an algorithm that is able to generate perturbations not only harmful against specific examples,
but in general. The authors interpret their results as a crucial milestone towards the goal of being able to identify and
hinder adversarial perturbations and thereby increasing the robustness of GNN models.
Besides the approach of statistically significant properties of harmful perturbations, they also rank the harmfullness of given perturbations
and provide a probability for certain perturbations being harmful. The work is a promising starting point in the direction of 
understanding the underlying mechanisms of harmful perturbations that could ultimately lead to approaches with general attack models 
that are ideally able to recognize incoming adversarial attacks based on their specific properties.
