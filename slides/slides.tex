...
\begin{frame}
  ...
  Wie lässt sich sicherstellen, dass kleine Änderungen an den Knoten-Features keine dramatischen Auswirkungen auf den Output haben?
\end{frame}
...
\begin{frame}
  ...
  $\rightarrow$ Es kann zu \textquote{false negatives} kommen, jedoch nicht zu \textquote{false positives}
\end{frame}
...
\begin{frame}
  ...
  $\rightarrow$ Qualität der \textquote{Classification}-Ergebnisse nicht schlechter
\end{frame}
